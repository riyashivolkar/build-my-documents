...
import menuData from "../utils/data/menuData"; // Adjust the import according to your file structure
import DecorativeSvg from "./DecorativeSvg"; // Adjust the import according to your file structure
...
const LeadsForm = () => {
  ...
  return (
    <div>
      <div className="relative mt-[920px] bg-white sm:mt-44 ">
