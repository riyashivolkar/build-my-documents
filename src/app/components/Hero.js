    ...
    <div className="relative flex items-center w-full h-screen bg-gray-50">
      <section className="relative w-full h-full py-16 sm:py-24 lg:py-32">
        ...
        <div className="container relative z-10 px-4 mx-auto text-center text-white">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-medium mb-4 sm:mb-6 lg:mb-8 text-[#f7941d]">
            Online Documents Consultancy.
          </h1>
          <p className="text-[13px] sm:text-[17px] md:text-[20px] mb-8 sm:mb-10 lg:mb-12">
