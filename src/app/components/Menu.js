...
const Menu = () => {
  return (
    <section className="text-gray-600 body-font">
      <div className="container px-4 mx-auto bg-white rounded-md shadow-2xl shadow-black py-14">
            ...
            item.path ? (
              <Link key={item.id} href={item.path} passHref>
                <div className="flex flex-col items-center justify-center h-48 p-2 border border-gray-200 rounded-lg cursor-pointer hover:bg-gray-100">
                  ...
                  <h2 className="mb-1 text-sm font-semibold text-gray-900 sm:text-base title-font">
                    {item.title}
                  </h2>
                </div>
              </Link>
