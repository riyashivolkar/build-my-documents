...
//             Contact Us
//           </h1>
//           <div className="relative flex items-end justify-start p-10 overflow-hidden bg-gray-300 rounded-lg w-full h-[300px] sm:h-[400px] md:h-[600px] md:w-full lg:w-full lg:h-[700px]">
//             <iframe
//               width="100%"
//               height="100%"
          ...
          <div className="relative flex items-end justify-start p-10 overflow-hidden bg-gray-300 rounded-lg w-full h-[300px] sm:h-[400px] md:h-[600px] md:w-full lg:w-full lg:h-[700px]">
            ...
            <div className="relative flex flex-wrap py-6 bg-white rounded shadow-md">
              ...
              <div className="px-6 mt-4 lg:w-1/2 lg:mt-0">
                ...
                <p className="py-1 text-xs leading-relaxed">+918263079329 </p>
